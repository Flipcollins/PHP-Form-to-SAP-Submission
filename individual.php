...
$sum = $_POST['mail_sub'] + $_POST['will_collect_sub'] + $_POST['mail_sub1'] + $_POST['will_collect_sub1'];
    ...
    <div class="w3-container">
        <h4 align="center"><font color="#228b22"><b>Thank you for submitting your application details.<br/>
                    Your online reference number is <?php echo $list['OBJECT_ID']; ?>
                </b></font></h4>
    </div>
    <div class="w3-container w3-center">
        ...
        <form method="post" action="https://paynow.pfms.gov.zw/paynow/do.payment.php" id="form">
                    ...
                    <table align="center" class="w3-table">
                        ...
                        <tr>
                            ...
                            <td><input required type="checkbox" name="amount"
                                       value="<?php echo $sum; ?>"
                    ...
                    <input required class="w3-btn  w3-red" type="submit" value="Process Final Payment via PAYNOW">
        ...
        <?php
            ...
            <div class="w3-container w3-center">
                <a href="uploading.php">
                    <button class="w3-btn w3-green">Attach proof of payment</button>
                </a>
            </div>
        ...
        <div id="renewal" class="w3-container w3-border app">
            <div class="w3-card-4">
                ...
                <form method="post" action="individual.php" class="w3-container"  name="myform">
                    ...
                    <div class="w3-panel w3-pale-green w3-leftbar w3-border-green">
                        <p>
                            ...
                            Services.<br>
							<p>Information should not be shared to third parties</p>
                            <br>
    ...
    <div class="w3-row-padding">
        ...
        <div class="w3-half">
            ...
            <input type="checkbox" name="APPTYPE" value="INDIVIDUAL"
                   style="display:none" checked="checked"/>
            ...
            <p>
                ...
                <input class="w3-input w3-border w3-light-grey " name="email" type="email" value="<?php echo $mail; ?>"
                    >
        ...
        <div class="w3-half">
            ...
            <p>
                ...
                <input class="w3-input w3-border " name="amountpaid" type="text" id="amountpaid"
 ...
 <div class="w3-panel w3-pale-red w3-leftbar w3-border-red">
            ...
            <div class="w3-panel w3-pale-red w3-leftbar w3-border-red">
                    Ten day Agromet Bulletin
                              </div>							     <div class="w3-panel w3-pale-green w3-leftbar w3-border-green">
                   <span class="w3-text-red"> <b>NB&nbsp;</b>Select mode before entering duration of subscription.</span>
                              </div>
                     ...
                     <p>
   <font color="red">*</font><input type="checkbox" name="declaration" required > I declare that the information given by me in this application is true and correct in every respect to the best of my knowledge and belief.
